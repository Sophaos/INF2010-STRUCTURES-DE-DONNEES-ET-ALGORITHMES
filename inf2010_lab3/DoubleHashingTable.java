...
public class DoubleHashingTable<AnyType> {
	...
	private static final int DEFAULT_R_VALUE = 5;
	private int R;
    ...
    { 
        int offset = 0;
        int currentPos = myhash( x ); // h1
        
        while( array[ currentPos ] != null && !array[ currentPos ].element.equals( x ) )
        {
        	++offset;
            currentPos += offset*(R - (x.hashCode() % R));  // h1 + i*H2 
            currentPos = currentPos % array.length; //  % N
